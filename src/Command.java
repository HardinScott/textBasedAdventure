 ...
 *
 * Objects of class Command can store an optional argument word (a second word
 * entered on the command line). If the command had only one word, then the
 * second word is <null>.
 * 
...
public abstract class Command {
	...
	/**
	 * Return the second word of this command. If no second word was entered, the
	 * result is null.
	 */
	...
	/**
	 * Define the second word of this command (the word entered after the command
	 * word). Null indicates that there was no second word.
	 */
	...
	/**
	 * Returns the name of the command. Useful to store it in the CommandWords class
	 */
	...
	/**
	 * Execute this command. A flag is returned indicating whether the game is over
